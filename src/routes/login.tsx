...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, Key, ChevronRight, CheckCircle2, User, Phone, Globe, Shield } from "lucide-react";
...
function App() {
  ...
  // Shared Video Background Shell Component
  const RenderShell = ({ children }: { children: React.ReactNode }) => (
    <PageTransition>
  ...
  // MAIN LOGIN VIEW (Split View: Floating Form + Right Showcase Panel)
  return (
    <RenderShell>
